...
namespace phmap {
    ...
    void printMap(std::ostream& out, const phmap::flat_hash_map<T1, T2>& v)
    {
        size_t counter = 0;
    ...
    template<typename T1, typename T2>
    void printMap(std::ostream& out, const phmap::parallel_flat_hash_map<T1, T2>& v)
    {
        size_t counter = 0;
	...
	template<typename T1, typename T2>
	std::ostream& operator<<(std::ostream& out, const phmap::flat_hash_map<T1, T2>& v) {
		printMap(out, v);
		return out;
	}

    template<typename T1, typename T2>
	std::ostream& operator<<(std::ostream& out, const phmap::parallel_flat_hash_map<T1, T2>& v) {
		printMap(out, v);
		return out;
	}

    template<typename T1, typename T2, typename T3, typename T4, typename T5>
    void flat_hash_map_add_to_lhs(phmap::flat_hash_map<T1, T2, T3, T4, T5>& lhs, const phmap::flat_hash_map<T1, T2, T3, T4, T5>& rhs)
    {
        ...
        {
            for (auto& item : rhs) {
                auto tmpItem = lhs.find(item.first);
                if (tmpItem != lhs.end())
                    lhs[item.first] = item.second + tmpItem->second;
                else
        ...
        {
            for (auto& item : lhs) {
                auto tmpItem = rhs.find(item.first);
                if (tmpItem != rhs.end())
                    lhs[item.first] = item.second + tmpItem->second;
            }
	...
	template<typename T1, typename T2, typename T3, typename T4, typename T5>
	phmap::flat_hash_map<T1, T2, T3, T4, T5>& operator += (phmap::flat_hash_map<T1, T2, T3, T4, T5>& lhs, const phmap::flat_hash_map<T1, T2, T3, T4, T5>& rhs)
	{
		flat_hash_map_add_to_lhs(lhs, rhs);
		return lhs;
	}
